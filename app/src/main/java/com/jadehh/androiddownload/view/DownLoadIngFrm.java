...
import com.jadehh.androiddownload.adapter.DownloadingListAdapter;
...
import com.jadehh.androiddownload.mvp.p.DownloadIngPresenter;
import com.jadehh.androiddownload.mvp.p.DownloadIngPresenterImp;
...
public class DownLoadIngFrm extends Fragment implements DownLoadIngView {
    ...
    private final List<DownloadTaskEntity> list = new ArrayList<>();
